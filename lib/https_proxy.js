(function() {
  var CERTS_DIR, HttpProxy, HttpsProxy, STATES, chain, chainGang, fs, generateCerts, getCerts, http, net, path, pipe, queueGenerateCerts, spawn, tls;
  ...
  exports.HttpsProxy = HttpsProxy = (function() {
    ...
    HttpsProxy.prototype.hijackSsl = function(headers, c) {
      ...
      host = match[1];
      port = match[2];
      return queueGenerateCerts(host, __bind(function(tlsContext) {
  ...
  queueGenerateCerts = function(host, tlsCallback) {
