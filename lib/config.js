(function() {
  var config, configFile, defaultConfig, defaultMfDir, homeDir, log, mfDir, mfPath, mfPaths, path, userConfig, _, _i, _len;
  ...
  mfPaths = [process.cwd() + '/.middlefiddle', defaultMfDir];
