(function() {
  var HttpProxy, Stream, addHeader, bodyLogger, config, connect, fs, http, https, isSecure, log, modifyHeaders, removeHeader, safeParsePath, sessionFilter, url, util, zlib,
  ...
  exports.HttpProxy = HttpProxy = (function(_super) {
