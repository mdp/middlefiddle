(function() {
  ...
  exports.HttpProxy = HttpProxy = (function() {
    ...
    HttpProxy.prototype.proxyCleanup = function(req, res, next) {
      ...
      contentLogger(req, function() {
        return req.emit('processed');
      });
      return next();
    };
    ...
    HttpProxy.prototype.outboundProxy = function(req, res, next) {
      ...
      upstream_processor = function(upstream_res) {
        ...
        contentLogger(res, function() {
          return res.emit('processed');
        });
  ...
  contentLogger = function(stream, callback) {
    var unzipper;
    stream.content = [];
    stream.length = 0;
    ...
    unzipper.on('data', function(data) {
      ...
      return stream.content.push(data);
    });
